...
import com.eatza.order.DeliveryServiceClient;
...
public class OrderServiceImpl implements OrderService {
	...
	@Value("${delivey.service.url}")
	private String deliveryServiceItemUrl;
	@Autowired
	...
	public Order placeOrder(OrderRequestDto orderRequest) throws OrderException {
		...
		logger.debug("Publishing message started");
		DeliveryRequestDto deliveryRequestDto = new DeliveryRequestDto(savedOrder.getId(), savedOrder.getCustomerId());
		kafkaSender.publish(deliveryRequestDto);
		return savedOrder;
	}
